...

{
     ...
     public partial class FrmMediatek : Form
     {
        ...
        private void AfficheAboInfo(Abonnement labonnement)
        {
            ...
            dtpAboDateCommande.Value = labonnement.DateCommande == DateTime.MinValue ? DateTime.Today : labonnement.DateCommande;
        ...
        private void dgvAboListeCom_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
          ...
          private void dgvDvdListeEx_CellContentClick(object sender, DataGridViewCellEventArgs e)
          {
